      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0">
          ...
          <div className="flex items-center space-x-4">
            ...
            {/* Instagram */}
            <a
              href="https://instagram.com/dalinsi_temple"
              target="_blank"
              rel="noopener noreferrer"
              className="text-paper/70 hover:text-paper transition-colors duration-200 hover:scale-110 transform"
            ...
            {/* YouTube */}
            <a
              href="https://youtube.com/@dalinsi_temple"
              target="_blank"
              rel="noopener noreferrer"
              className="text-paper/70 hover:text-paper transition-colors duration-200 hover:scale-110 transform"
              aria-label="YouTube"
            ...
            {/* Facebook */}
            <a
              href="https://facebook.com/dalinsi.temple"
              target="_blank"
              rel="noopener noreferrer"
              className="text-paper/70 hover:text-paper transition-colors duration-200 hover:scale-110 transform"
              aria-label="Facebook"
