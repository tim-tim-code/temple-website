...
const AnimatedCardStack: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Card 1 */}
      <div className={`absolute inset-1 rounded-2xl transform-gpu transition-all duration-300 ease-in-out flex flex-col items-center justify-center text-white font-bold text-shadow bg-gradient-to-t from-blue-600 to-purple-600 origin-bottom-left ${isHovered ? 'animate-card1' : ''}`}>
      ...
      {/* Card 2 */}
      <div className={`absolute inset-1 rounded-2xl transform-gpu transition-all duration-300 ease-in-out flex flex-col items-center justify-center text-white font-bold text-shadow bg-gradient-to-t from-green-400 to-cyan-400 opacity-0 origin-bottom-left ${isHovered ? 'animate-card2' : ''}`}>
        <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Card 3 */}
      <div className={`absolute inset-1 rounded-2xl transform-gpu transition-all duration-300 ease-in-out flex flex-col items-center justify-center text-white font-bold text-shadow bg-gradient-to-br from-orange-300 to-orange-100 opacity-0 origin-bottom-left ${isHovered ? 'animate-card3' : ''}`}>
        <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Card 4 */}
      <div className={`absolute inset-1 rounded-2xl transform-gpu transition-all duration-300 ease-in-out flex flex-col items-center justify-center text-white font-bold text-shadow bg-gradient-to-br from-gray-600 to-gray-800 opacity-0 origin-bottom-left ${isHovered ? 'animate-card4' : ''}`}>
